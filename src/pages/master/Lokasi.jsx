...
const Lokasi = () => {
  ...
  // Data sesuai INSERT SQL ref_lokasi_absensi
  const [listLokasi] = useState([
    {
      id_lokasi: 1,
      nama_lokasi: "Kantor Perampuan",
      latitude: -8.639211,
      longitude: 116.087634,
      radius_meter: 50,
      status: 1,
    },
    {
      ...
      latitude: -8.674594,
      longitude: 116.086204,
      radius_meter: 15,
      status: 1,
    },
    {
      id_lokasi: 3,
      nama_lokasi: "PLTGU Jeranjang",
      latitude: -8.65961,
      longitude: 116.074014,
      radius_meter: 100,
      status: 1,
    },
    {
      id_lokasi: 4,
      nama_lokasi: "UPK Ampenan",
      latitude: -8.599413,
      longitude: 116.074805,
      radius_meter: 100,
      status: 1,
    },
    {
      id_lokasi: 5,
      nama_lokasi: "Lombok Peaker",
      latitude: -8.589523,
      longitude: 116.075144,
      radius_meter: 100,
      status: 1,
    },
  ]);
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      {showModal && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in zoom-in duration-300">
          <div className="bg-white dark:bg-custom-gelap w-full max-w-lg rounded-[40px] shadow-2xl overflow-hidden border border-white/20">
            ...
            <div className="p-8 pt-4 space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button className="flex-1 py-4 bg-custom-merah-terang text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg flex items-center justify-center gap-2">
                  <MdCheckCircle size={18} /> Simpan Lokasi
                </button>
                <button
                  onClick={() => setShowModal(false)}
